  ...
  factory: (require) => {
    ...
    function TileWorkbench(props) {
      ...
      var zoomOverlay = zoom[0] ? React.createElement('div', {
        ...
        React.createElement('img', { src: API + '/img?p=' + encodeURIComponent(zoom[0].path), style: { maxWidth: '92vw', maxHeight: '84vh', objectFit: 'contain', borderRadius: '8px' }, alt: zoom[0].id }),
    ...
    function DockWorkbench(props) {
      ...
      if (!otherWs && open[0]) {
        workbenchModal = React.createElement('div', {
          style: { position: 'fixed', inset: '0', zIndex: 9998, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '4vh 4vw' },
