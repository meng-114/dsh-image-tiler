...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function TileWorkbench(props) {
      ...
      var paramsRow1 = React.createElement('div', { style: Object.assign({}, WB_STYLES.row, { flexWrap: 'nowrap' }) },
        ...
        React.createElement('span', { style: WB_STYLES.num }, 'px'),
        React.createElement('span', { style: WB_STYLES.label }, '列 × 行'),
        numInput('cols', p.cols, 1, 24, setCols, '列数（等分网格）'),
        React.createElement('span', { style: WB_STYLES.num }, '×'),
        numInput('rows', p.rows, 1, 24, setRows, '行数（等分网格）'),
        React.createElement('span', { style: WB_STYLES.num }, '行'),
      )
      var paramsRow2 = React.createElement('div', { style: Object.assign({}, WB_STYLES.row, { flexWrap: 'nowrap' }) },
        ...
        previewTiles ? React.createElement('span', { style: WB_STYLES.num },
