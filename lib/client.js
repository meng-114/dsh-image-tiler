  ...
  factory: (require) => {
    ...
    function TileWorkbench(props) {
      ...
      var header = React.createElement('div', { style: WB_STYLES.row },
        ...
        React.createElement('span', { style: WB_STYLES.num }, p.tileSize + 'px'),
        ...
        React.createElement('span', { style: WB_STYLES.num }, p.overlap + 'px'),
      ...
      // Canvas: source preview + live grid overlay.
      var canvas = null
    ...
    function DockWorkbench(props) {
      ...
      return React.createElement('div', { style: { width: '100%' } },
        React.createElement('div', { style: Object.assign({}, WB_STYLES.row, { justifyContent: 'space-between' }) },
          React.createElement('span', { style: WB_STYLES.status },
        ...
        open[0] ? React.createElement(TileWorkbench, { afterLoad: load }) : null,
      )
    }
